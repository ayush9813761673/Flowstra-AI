...
export function GlowingShadow({ children, className, containerClassName }: GlowingShadowButtonProps) {
  return (
    <>
      ...
      <div className={cn("glow-container w-full h-full", containerClassName)}>
        ...
        <div className={cn("glow-content w-full h-full text-left bg-[var(--surface)] relative z-10 overflow-hidden", className)}>
          {children}
        </div>
      </div>
    </>
